...
<html lang="ja">
  ...
  <body <?php body_class();?>>
    <div class="u-all-wrap">
      ...
      <!--header-->
      <header class="l-top-header u-another-background2">
          <div class="u-js-nav-wrapper1">
            <nav>
              <ul class="c-flex-nav u-padding5">
                <li class="u-js-nav-item"><a class="c-flex-nav__link change1 u-another-font4" href="<?php echo esc_url(home_url('/'));?>">Top</a></li>
                <li class="u-js-nav-item"><a class="c-flex-nav__link change2 u-another-font4" href="<?php echo esc_url(home_url('/'));?>#search">Search</a></li>
                <li class="u-js-nav-item"><a class="c-flex-nav__link change3 u-another-font4" href="<?php echo esc_url(home_url('/'));?>#function">Function</a></li>
                <li class="u-js-nav-item"><a class="c-flex-nav__link change4 u-another-font4" href="<?php echo esc_url(home_url('case'));?>">Case</a></li>
                <li class="u-js-nav-item"><a class="c-flex-nav__link change5 u-another-font4" href="<?php echo esc_url(home_url('security'));?>">Security</a></li>
                <li class="u-js-nav-item"><a class="c-flex-nav__link change7 u-another-font4" href="<?php echo esc_url(home_url('price'));?>">Price</a></li>
                <li class="u-js-nav-item u-another-header-pc">
                  <p class="c-flex-nav__link change8 u-another-font4">Option ▼</p>
                  <ul class="c-flex-nav__mouseover">
                    <li><a class="u-another-font4" href="<?php echo home_url('fos');?>">F・O・S</a></li>
                    <li><a class="u-another-font4" href="<?php echo home_url('online');?>">オリジナルワーク設計</a></li>
                    <li><a class="u-another-font4" href="<?php echo home_url('upcomerkit');?>">Upcomer kit</a></li>
                  </ul>
                </li>
            ...
            <nav class="u-js-header-nav">
              <ul class="c-flex-nav">
                ...
                <li class="u-js-nav-item">
                  ...
                  <ul class="c-flex-nav__mouseover">
                    <li><a class="u-color7" href="<?php echo esc_url(home_url('fos'));?>">F・O・S</a></li>
                    <li><a class="u-color7" href="<?php echo esc_url(home_url('online'));?>">オリジナルワーク設計</a></li>
                    <li><a class="u-color7" href="<?php echo esc_url(home_url('upcomerkit'));?>">Upcomer kit</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
          ...
          <div class="u-js-burger-btn">
            ...
            <div class="l-case">
                <p class="l-case__title">運用事例からイメージする</p>
            </div>
      </header>