...
<html lang="ja">
  ...
  <body <?php body_class();?>>
    <div class="u-all-wrap">
      ...
      <!--トップページの検索の部分に戻るボタン-->
      <a href="<?php echo home_url('/');?>#search" class="u-another-link"><i class="fas fa-chevron-left"></i></a>
      ...
      <header class="l-top-header u-another-background u-padding4">
          ...
          <div class="u-bgc12">
              <div class="l-rest-wrap">
                  <h2 class="l-rest-wrap__title">若手を定着させるための新入社員フォロー</h2>
                  <p class="l-rest-wrap__content u-width78">人事と配属後の新入社員をつなぐホットラインとして、<br>配属後の同期交流の場を用意することで早期退職者を防止</p>
              </div>
          </div>
